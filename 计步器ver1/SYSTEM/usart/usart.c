...
u16 D2Cover=0; //The distance to cover in the following peroid  Unit:mm
...
void USART1_IRQHandler(void)                	
{
	...
	if(USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)  
	{
		...
		if(cnum==5)
		{
			...
			{ 
			  D2Cover=(u16)(((dectr[2]-'0')*100+(dectr[3]-'0')*10+(dectr[4]-'0'))/stepunit);
				modeflag=1;
	      count_1=5000;
				count_2=1;
			}
	      ...
	      count_1=5000;
			...
			else if(dectr[1]=='3')    //let to send the value of count_1 in this moment
			{
